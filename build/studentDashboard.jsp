...
<head>
    ...
    <title>Student Dashboard - TestVerse</title>
                                ...
                                <div>
                                    <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 0.75rem;">
                                        ...
                                        <span style="font-size: 0.85rem; color: var(--text-muted); font-weight: 600;">
                                            â± <c:out value="${test.durationMinutes}"/> mins
                                        </span>
                                    </div>
                                    ...
                                    <c:choose>
                                        <c:when test="${test.attempted}">
                                            <div class="alert alert-success" style="margin-bottom: 0; padding: 0.65rem 0.85rem; justify-content: center; font-weight: 700;">
                                                âœ“ Completed â€” Score: <c:out value="${test.studentScore}"/> / <c:out value="${test.totalMarks}"/>
                                            </div>
                                        </c:when>
                                        <c:otherwise>
